---
type: knowledge
tags: [suppliers, lead-times, planning]
updated: 2026-07-08
source: person
confidence: working
---
...
- In-stock items from Cascadia and Fable have arrived on time every order.
- The safe play: spec from stock for anything on the critical path; reserve
  made-to-order for items that can arrive after install.

Marked `working` because the sample is small (7 orders); revisit after the
Harborview flooring delivery lands.
